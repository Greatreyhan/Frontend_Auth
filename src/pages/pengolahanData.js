...
const PengolahanData = () => {
  ...
  return (
    <div>
      {popUpDetail && <PopUpDetailRecord popUpDetail={popUpDetail} setPopUpDetail={setPopUpDetail} idRecordDetail={idRecordDetail}/>}
            ...
            <div className="text-end">
              <form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
                <div className=" relative ">
                  <input type="text" id="&quot;form-subscribe-Filter" className="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-gray-100 text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-rose-600 focus:border-transparent" placeholder="name" />
                </div>
                <button className="flex-shrink-0 px-6 py-2 text-base text-white bg-rose-700 rounded-lg shadow-md hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 focus:ring-offset-rose-200" type="submit">
                  Cari
                </button>
              </form>
            </div>
                  ...
                  KTPRecord.map((record)=>{
                    return(
                      <tr key={record.idktp}>
                        ...
                        <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                          <button onClick={e=>handleShowDetail(e,record.uuid)} href="#" className="text-indigo-600 hover:text-indigo-900">
                          detail
                          </button>
                        </td>
                      </tr>
